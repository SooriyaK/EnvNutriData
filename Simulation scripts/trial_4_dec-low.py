...
environmental_data = [1000, # metabolite A / 0 (importer)
                      500, # metabolite B / 1
                      578, # metabolite C / 2 (importer)
                      500, # metabolite D / 3
                      334, # metabolite E / 4 (importer)
                      500, # metabolite F / 5
                      193, # metabolite G / 6 (importer)
                      500, # metabolite H / 7
                      111, # metabolite I / 8 (importer)
                      500, # metabolite J / 9
                      64, # metabolite K / 10 (importer)
                      500, # metabolite L / 11
                      5, # metabolite M / 12 (importer)
                      500, # metabolite N / 13
                      5, # metabolite O / 14 (importer)
                      500, # metabolite P / 15
                      5, # metabolite Q / 16 (importer)
                      500, # metabolite R / 17
                      5, # metabolite S / 18 (importer)
                      500, # metabolite T / 19
                      5, # metabolite U / 20 (importer)
                      500, # metabolite V / 21
                      5, # metabolite W / 22 (importer)
                      500, # metabolite X / 23
                      5  # metabolite Y / 24 (importer)
                     ]

parameters = {# Part 1: Simulation metadata
              "simulation_name": "trial_10_dec-low",
