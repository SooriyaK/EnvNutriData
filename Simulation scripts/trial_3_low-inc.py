...
environmental_data = [5, # metabolite A / 0 (importer)
                      500, # metabolite B / 1
                      5, # metabolite C / 2 (importer)
                      500, # metabolite D / 3
                      5, # metabolite E / 4 (importer)
                      500, # metabolite F / 5
                      5, # metabolite G / 6 (importer)
                      500, # metabolite H / 7
                      5, # metabolite I / 8 (importer)
                      500, # metabolite J / 9
                      5, # metabolite K / 10 (importer)
                      500, # metabolite L / 11
                      5, # metabolite M / 12 (importer)
                      500, # metabolite N / 13
                      64, # metabolite O / 14 (importer)
                      500, # metabolite P / 15
                      111, # metabolite Q / 16 (importer)
                      500, # metabolite R / 17
                      193, # metabolite S / 18 (importer)
                      500, # metabolite T / 19
                      334, # metabolite U / 20 (importer)
                      500, # metabolite V / 21
                      578, # metabolite W / 22 (importer)
                      500, # metabolite X / 23
                      1000  # metabolite Y / 24 (importer)
                     ]

parameters = {# Part 1: Simulation metadata
              "simulation_name": "trial_9_low-inc",
