...
environmental_data = [10, # metabolite A / 0 (importer)
                      500, # metabolite B / 1
                      10, # metabolite C / 2 (importer)
                      500, # metabolite D / 3
                      10, # metabolite E / 4 (importer)
                      500, # metabolite F / 5
                      10, # metabolite G / 6 (importer)
                      500, # metabolite H / 7
                      10, # metabolite I / 8 (importer)
                      500, # metabolite J / 9
                      10, # metabolite K / 10 (importer)
                      500, # metabolite L / 11
                      10, # metabolite M / 12 (importer)
                      500, # metabolite N / 13
                      10, # metabolite O / 14 (importer)
                      500, # metabolite P / 15
                      10, # metabolite Q / 16 (importer)
                      500, # metabolite R / 17
                      10, # metabolite S / 18 (importer)
                      500, # metabolite T / 19
                      10, # metabolite U / 20 (importer)
                      500, # metabolite V / 21
                      10, # metabolite W / 22 (importer)
                      500, # metabolite X / 23
                      10  # metabolite Y / 24 (importer)
                     ]

parameters = {# Part 1: Simulation metadata
              "simulation_name": "control_high",
