...
environmental_data = [5, # metabolite A / 0 (importer)
                      500, # metabolite B / 1
                      12, # metabolite C / 2 (importer)
                      500, # metabolite D / 3
                      28, # metabolite E / 4 (importer)
                      500, # metabolite F / 5
                      69, # metabolite G / 6 (importer)
                      500, # metabolite H / 7
                      168, # metabolite I / 8 (importer)
                      500, # metabolite J / 9
                      410, # metabolite K / 10 (importer)
                      500, # metabolite L / 11
                      1000, # metabolite M / 12 (importer)
                      500, # metabolite N / 13
                      410, # metabolite O / 14 (importer)
                      500, # metabolite P / 15
                      168, # metabolite Q / 16 (importer)
                      500, # metabolite R / 17
                      69, # metabolite S / 18 (importer)
                      500, # metabolite T / 19
                      28, # metabolite U / 20 (importer)
                      500, # metabolite V / 21
                      12, # metabolite W / 22 (importer)
                      500, # metabolite X / 23
                      5  # metabolite Y / 24 (importer)
                     ]

parameters = {# Part 1: Simulation metadata
              "simulation_name": "trial_12_inverse-v",
